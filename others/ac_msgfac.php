...
<html>
    ...
    <body>
        ...
        <div class="hbox"><h3>Messages</h3></div>
                <div class="sbox">
                    <div class="controls">
                    <a href="../others/ac_newmsg.php" class="msg"><input type="submit" value="New Message" class="msga"></a>
                    <a href="../others/ac_sentmsgfac.php" class="msg"><input type="submit" value="Sent Messages" class="msgb"></a>
                    </div>      
