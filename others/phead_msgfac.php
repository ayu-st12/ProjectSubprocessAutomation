...
<html>
    ...
    <body>
        ...
        <div class="hbox"><h3>Messages</h3></div>
                <div class="sbox">
                    <div class="controls">
                    <a href="../others/phead_newmsg.php" class="msg"><input type="submit" value="New Message" class="msga"></a>
                    <a href="../others/phead_sentmsgfac.php" class="msg"><input type="submit" value="Sent Messages" class="msgb"></a>
                    </div>      
            ...
            <tbody>
                <?php
                    $query = "select * from messages where to_g = '$user' order by dt_time desc";
                ...
                <td><?php echo fetch1(name, user_detail, username, $value['username']) ?></td>
                </tr>
                <?php } ?>
            </tbody>
        </table><br>
