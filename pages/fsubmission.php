    ...
    <body>
        ...
        <table border="1">
            ...
            <tbody>
                ...
                $td = $proj_id[$i][0];
                $name = array();
                $teamd = fetch1(teamid, project_team_info, pid, $td);
                ...
                <tr>
                    ...
                    <td><?php for($i=0;$i<count($name);$i++){ echo $name[$i][0]."<br>";} ?></td>
                    <td><a href="../others/marks.php?passkey=<?php echo $value['pid']; ?>"><input type="submit" value="Submit Marks"></a></td>
                </tr>
            <?php                }          }}}
                ?>
            </tbody>
