<?php
    ...
    $query = "select * from project_detail where mentor = '$myname' and acceptance_mentor = 'false'";
        ...
        <table border="1">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><a href="http://localhost:13138/others/confirmation.php?passkey=<?php echo $conf;?>&passkey1=<?php echo $pid?>"><input type="button" value="Approve"></a></td>
                    <td><a href="http://localhost:13138/others/confirmation.php?passkey=1&passkey1=<?php echo $pid?>"><input type="button" value="Reject"></a></td>
                </tr>
            <?php       } ?>
            </tbody>
        </table>
